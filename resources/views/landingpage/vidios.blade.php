        ...
        <div class="container">
            ...
            <div class="row mb-4">
                <div class="col-lg-8 mx-auto text-center">
                    <h2 class="fs-1">Healthy Lifestyle Videos</h2>
                    <p class="mb-0">Berbagai macam vidio menarik mengenai hidup sehat.</p>
                </div>
            </div>
                    ...
                    <div class="col-sm-6 col-lg-4 col-xl-3">
                        <div class="card shadow h-100">
                            ...
                            <div class="card-body pb-0">
                                <h5 class="card-title fw-normal"><a href="#">{{$val->name}}</a></h5>
                                <p class="mb-2 text-truncate-2">{{$val->descripsi}}</p>
                            </div>
                            <!-- Card footer -->
