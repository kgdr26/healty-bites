    ...
    <div class=" container-fluid  d-flex flex-stack flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
            ...
            <h1 class="text-dark fw-bold my-1 fs-2">
                Challenge <small class="text-muted fs-6 fw-normal ms-1"></small>
            </h1>
            <!--end::Title-->
            ...
            <ul class="breadcrumb fw-semibold fs-base my-1">
                <li class="breadcrumb-item text-muted">
                    <a href="" class="text-muted text-hover-primary">Challenge</a>
                </li>
                <li class="breadcrumb-item text-muted">Weekly Nutrition Challenge </li>
            </ul>
            <!--end::Breadcrumb-->
        </div>
        <!--end::Info-->
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="main_table">
                    ...
                    <thead>
                        <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                            <th>NO</th>
                            <th>Weekly Nutrition Challenge NAME</th>
                            <th>STATUS</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-center">
                                        <button type="button" class="btn btn-success me-3" data-name="sett_data" data-item="{{$val->id}},{{$val->name}}">
                                            Active
                                        </button>
                                        <button type="button" class="btn btn-info me-3" data-name="edit_data" data-item="{{$val->id}},{{$val->name}}">
                                            Edit
                                        </button>
                                        <button type="button" data-name="delete_data" class="btn btn-danger" data-item="{{$val->id}},{{$val->name}}">
                                            Delete
                                        </button>
                                    </div>
                                </td>
